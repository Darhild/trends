...
def test_trends_handler_today_for_mix_various_num_docs(client, num_docs, mix_data_today):
    mix_various_num_docs(client=client, period=1, num_docs=num_docs, mix_data=mix_data_today)
...
def test_trends_handler_week_for_mix_various_num_docs(client, num_docs, mix_data_week):
    mix_various_num_docs(client=client, period=7, num_docs=num_docs, mix_data=mix_data_week)


@pytest.mark.parametrize(
    ("num_docs",), [(1,), (4,), (10,), (17,), (21,), ]
)
def test_trends_handler_month_for_mix_various_num_docs(client, num_docs, mix_data_month):
    mix_various_num_docs(client=client, period=30, num_docs=num_docs, mix_data=mix_data_month)
