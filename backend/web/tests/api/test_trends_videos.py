...
def videos_with_tag(client, period, tag, videos_data):
    ...
    response = client.get(
        url_for('trends.videos_handler', **params),
    )
...
def test_videos_handler_today_for_videos_shuffle(client, tag, videos_data_today):
    videos_not_shuffle_data(client=client, period=1, tag=tag, videos_data=videos_data_today)
...
def test_videos_handler_week_for_videos_shuffle(client, tag, videos_data_week):
    videos_not_shuffle_data(client=client, period=7, tag=tag, videos_data=videos_data_week)
...
def test_videos_handler_month_for_videos_shuffle(client, tag, videos_data_month):
    videos_not_shuffle_data(client=client, period=30, tag=tag, videos_data=videos_data_month)

@pytest.mark.parametrize(
    ("tag", ), TAGS_FOR_VIDEOS
)
def test_videos_handler_today_for_videos_empty_db(clear_videos_table_in_db, client, tag):
...
def test_videos_handler_month_for_videos_empty_db(clear_videos_table_in_db, client, tag):
...
def test_videos_handler_today_for_videos_various_num_docs(client, num_docs, videos_data_today):
    videos_various_num_docs(client=client, period=1, num_docs=num_docs, videos_data=videos_data_today)


@pytest.mark.parametrize(
    ("num_docs",), [(1,), (4,), (10,), (17,), (21,), ]
)
def test_videos_handler_week_for_videos_various_num_docs(client, num_docs, videos_data_week):
    videos_various_num_docs(client=client, period=7, num_docs=num_docs, videos_data=videos_data_week)


@pytest.mark.parametrize(
    ("num_docs",), [(1,), (4,), (10,), (17,), (21,), ]
)
def test_videos_handler_month_for_videos_various_num_docs(client, num_docs, videos_data_month):
    videos_various_num_docs(client=client, period=30, num_docs=num_docs, videos_data=videos_data_month)
