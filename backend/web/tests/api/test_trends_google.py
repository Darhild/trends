...
def test_trends_handler_today_for_google_various_num_docs(
    client, num_docs, google_data_today
):
    google_various_num_docs(
        client=client, period=1, num_docs=num_docs, google_data=google_data_today
    )


@pytest.mark.parametrize(("num_docs",), [(1,), (4,), (10,), (17,), (21,),])
def test_trends_handler_week_for_google_various_num_docs(
    client, num_docs, google_data_week
):
    google_various_num_docs(
        client=client, period=7, num_docs=num_docs, google_data=google_data_week
    )


@pytest.mark.parametrize(("num_docs",), [(1,), (4,), (10,), (17,), (21,),])
def test_trends_handler_month_for_google_various_num_docs(
    client, num_docs, google_data_month
):
    google_various_num_docs(
        client=client, period=30, num_docs=num_docs, google_data=google_data_month
    )
